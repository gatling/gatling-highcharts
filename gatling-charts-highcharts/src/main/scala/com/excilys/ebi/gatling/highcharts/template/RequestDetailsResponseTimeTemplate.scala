...
class RequestDetailsResponseTimeTemplate(successSeries: ResponseTimeSeries, failuresSeries: ResponseTimeSeries, activeSessionSeries: NumberPerSecondSeries) extends Template {
