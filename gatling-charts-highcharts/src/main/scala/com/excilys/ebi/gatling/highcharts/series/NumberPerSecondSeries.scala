...
class NumberPerSecondSeries(name: String, runStart: Long, data: Seq[IntVsTimePlot], color: String) extends Series[IntVsTimePlot](escapeJsQuoteString(name), data, Vector(color)) {
