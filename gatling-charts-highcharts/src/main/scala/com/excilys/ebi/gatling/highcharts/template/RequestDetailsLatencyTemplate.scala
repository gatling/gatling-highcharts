...
class RequestDetailsLatencyTemplate(successSeries: ResponseTimeSeries, failuresSeries: ResponseTimeSeries, activeSessionSeries: NumberPerSecondSeries) extends Template {
